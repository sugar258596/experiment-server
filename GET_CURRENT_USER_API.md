...
系统提供了**两个接口**来获取当前登录用户的信息，分别适用于不同的使用场景。
...
- **2025-11-08**: 添加获取当前用户信息接口
- **2025-11-08**: 完善接口文档和示例
- **2025-11-08**: 添加简化版接口 `/user/me`
...
两个接口都需要 JWT 认证，返回的响应格式清晰，便于前端使用。
